...
/**
 * The /book page (appointments variant). Installed by the Klaudius booking
 ...
 * settings/catalogue changes must show up without a redeploy.
 */
  ...
  return (
    <main className="mx-auto max-w-xl px-5 py-14">
      ...
      <p className="mt-2 mb-8 text-neutral-600">
        Pick a service, date and time — you'll get an instant email confirmation.
      </p>
      <BookingForm cfg={cfg} />
      {s.businessPhone && (
