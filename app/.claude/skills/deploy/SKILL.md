...
allowed-tools: Bash(npx *), Bash(npm *), Bash(node *), Bash(python3 *), Bash(bash *), Bash(git *), Bash(rm *), Bash(cd *), Bash(cat *), Bash(grep *), Bash(test *), Bash(curl *), Bash(rsync *), Bash(find *), Bash(tee *), Bash(mkdir *), Bash(sed *), Bash(awk *), Bash(sleep *), Bash(head *), Bash(cut *), Bash(tr *), Bash(echo *), Bash(printf *), Bash(for *), Read, Write, Skill
---
